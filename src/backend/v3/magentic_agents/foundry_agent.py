...
from azure.ai.agents.models import AzureAISearchTool, CodeInterpreterToolDefinition  # BingGroundingTool
...
from v3.magentic_agents.models.agent_models import MCPConfig, SearchConfig  # BingConfig
